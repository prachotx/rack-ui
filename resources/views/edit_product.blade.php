        ...
        <div class="p-[20px] border-base-400 border-2 border-t-0 rounded-b-box">
            <form method="POST" action="/update_product/{{ $product->id }}">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-3">
                        <input type="text" name="code" class="input input-bordered w-full" value="{{ $product->code }}">
                    </div>
                </div>
                @error('code')
                    <div class="my-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-3">
                        <input type="text" name="name" class="input input-bordered w-full" value="{{ $product->name }}">
                    </div>
                </div>
                @error('name')
                    <div class="my-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-3">
                        {!! Form::select('product_type_id', $product_types, $product->product_type_id, ['class' => 'select select-bordered w-full']) !!}
                    </div>
                </div>
