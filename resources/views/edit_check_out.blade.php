...
<div class="shadow rounded-box mx-auto">
    ...
    <div class="p-[20px] border-base-400 border-2 border-t-0 rounded-b-box">
        <form method="POST" action="/update_check_out/{{ $check_out->id }}">
            @csrf
            <div class="mb-3">
                <label for="out_date" class="font-bold">Date</label>
                <div class="mt-3">
                    <input type="date" id="date" name="out_date" class="input input-bordered w-full" value="{{ $check_out->out_date }}">
                </div>
            </div>
            @error('out_date')
            <div class="my-3">
            ...
            <div class="mb-3">
                ...
                <div class="mt-3">
                    <input type="text" name="remark" class="input input-bordered w-full"  value="{{ $check_out->remark }}">
                </div>
            </div>
            @error('remark')
            <div class="my-3">
